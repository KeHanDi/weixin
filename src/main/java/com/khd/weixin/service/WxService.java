...
public class WxService {
    ...
    //微信公众号
    private static final String APPID = "wx5c758071cdbb1efa";
    private static final String APPSECRET = "011781879da2c991a17515c2565cdf38";
    //百度AI
    ...
    private static BaseMessage dealTextMessage(Map<String, String> requestMap) {
        ...
        if (msg.equals("图文")) {
            ...
            articles.add(new Article("这是图文消息的标题", "这是图文消息的详细介绍", "http://photo.16pic.com/00/01/11/16pic_111395_b.jpg", "http://www.baidu.com"));
            NewsMessage nm = new NewsMessage(requestMap, articles);
            return nm;
        }
        if (msg.equals("登录")) {
            String url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + APPID +
                    "&redirect_uri=http://www.6sdd.com/weixin/GetUserInfo&response_type=code&scope=snsapi_userinfo#wechat_redirect";
